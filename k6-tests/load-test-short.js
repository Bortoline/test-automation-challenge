...
export function handleSummary(data) {
  return {
    ...
    "../reports/k6/summary-short.json": JSON.stringify(data, null, 2),
    "../reports/k6/summary-short.txt": textSummary(data, { indent: " ", enableColors: false }),
    "../reports/k6/report-short.html": htmlReport(data),
  };
}
